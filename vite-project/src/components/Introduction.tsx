...
export function Introduction() {
  return (
    <div className="relative w-full z-10">
      <div className="relative 2xl:h-[45vh] xl:h-[60vh] md:h-[35vh] h-[30vh] bg-green-800">
        ...
        <div className="relative h-full max-w-5xl mx-auto">
          <div className="absolute left-0 -bottom-20 lg:-bottom-35 lg:w-1/3 px-4 lg:px-4 flex flex-col items-start lg:items-center ">
            <img
              src={jungeun}
              alt="Profile"
